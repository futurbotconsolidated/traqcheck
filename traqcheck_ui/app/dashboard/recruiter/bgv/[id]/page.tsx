            ...
            <div className="flex justify-between h-16 items-center">
              <div className="flex items-center gap-4">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => router.push(ROUTES.RECRUITER_DASHBOARD)}
                >
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {bgv.user && (
                      <div>
                        <p className="text-sm font-medium text-gray-500">Candidate User</p>
                        <p className="text-lg">{bgv.user.full_name}</p>
                        <p className="text-sm text-gray-500">{bgv.user.email}</p>
                      </div>
                    )}
                    {bgv.recruiter && (
                      <div>
              ...
              {bgv.documents && bgv.documents.length > 0 && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Documents submitted by the candidate for background verification
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
